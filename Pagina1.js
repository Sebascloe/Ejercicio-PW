...
const peliculas = [
    ...
    { id: 2, titulo: 'Star Wars Collection: Darth Vader White (Special Christmas 2024 Disney Edition)', precio: 65.99, cantidad: 2, subtotal: 65.99 },
    { id: 3, titulo: 'Star Wars Collection: Darth Vader White (Special Christmas 2024 Disney Edition 2)', precio: 65.99, cantidad: 2, subtotal: 65.99 },
];
...
function Cuerpo() {
    ...
    const handleCheckout = () => {
        navigate('/pagina2', {state: {productos}});
    };
